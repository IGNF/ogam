Role('Siesta.Test.Self', {
    ...
    methods : {
        ...
        getSelfTest : function (meta, config, doNotTranslate) {
            ...
            config.harness.browserWindowHasFocus = function () {
                return true
            }
        ...
        getHarness : function(config, tests, doNotStart) {
            var Siesta      = this.global.Siesta;
            var Harness     = this.global.Harness = new Siesta.Harness.Browser.ExtJS()
        ...
        getTouchHarness : function(config, tests) {
            var Siesta      = this.global.Siesta;
            var Harness     = this.global.Harness = new Siesta.Harness.Browser.SenchaTouch()

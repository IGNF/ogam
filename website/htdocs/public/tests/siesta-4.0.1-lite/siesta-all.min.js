...
b,c,!1,!0)):"Date"==d?!Boolean(a-b)&&(!c||this.compareObjects(a,b,c,!1,!0)):!1}}});Role("Siesta.Util.Role.CanEscapeRegExp",{methods:{escapeRegExp:function(a){return a.replace(/[\-\[\]\/\{\}\(\)\*\+\?\.\\\^\$\|]/g,"\\$&")}}});
...
else{var D,z=new Date,A=function(){var m=new Date-z;if(m>d)l.endAsync(x),l.finalizeWaiting(w,!1,f.get("waitedTooLong")+": "+g,{assertionName:k,annotation:f.get("conditionNotFulfilled")+" "+d+f.get("ms")},s,q),y=!0;else{try{D=a.call(c||l)}catch(p){l.endAsync(x);l.finalizeWaiting(w,!1,k+" "+f.get("checkerException"),{assertionName:k,got:p.toString(),gotDesc:f.get("Exception")},s,q);y=!0;return}null!=D&&!1!==D?(l.endAsync(x),y=!0,l.finalizeWaiting(w,!0,f.get("Waited")+" "+m+" "+f.get("msFor")+" "+g,
null,null,q),l.processCallbackFromTest(b,[D],c||l)):v=n(A,e)}};A()}return{force:function(){y||(y=!0,p(v),l.endAsync(x),l.finalizeWaiting(w,!0,f.get("forcedWaitFinalization")+" "+g,null,null,q),l.processCallbackFromTest(b,[],c||l))}}},waitForMs:function(){return this.waitFor.apply(this,arguments)},waitForFn:function(){return this.waitFor.apply(this,arguments)},analyzeChainStep:function(a){a=a.toString();var b=a.match(/function\s*[^(]*\(\s*(.*?)\s*(?:,|\))/)[1];return b?-1!=a.match(/\{([\s\S]*)\}/)[1].indexOf(b):
...
Class("Siesta.Test",{does:[Siesta.Util.Role.CanFormatStrings,Siesta.Util.Role.CanGetType,Siesta.Util.Role.CanCompareObjects,Siesta.Util.Role.CanEscapeRegExp,Siesta.Test.More,Siesta.Test.Date,Siesta.Test.Function,Siesta.Test.BDD,JooseX.Observable],has:{name:null,url:{required:!0},urlExtractRegex:{is:"rwc",lazy:function(){return RegExp(this.url.replace(/([.*+?^${}()|[\]\/\\])/g,"\\$1")+":(\\d+)")}},assertPlanned:null,assertCount:0,isTodo:!1,results:{lazy:function(){return new Siesta.Result.SubTest({description:this.name||
...
e,c.passed=!1,c.annotation=b,c.description=a);this.addResult(c||new Siesta.Result.Assertion({name:e,passed:!1,sourceLine:d,annotation:String(b||""),description:String(a||"")}));if(!this.isTodo&&(this.harness.debuggerOnFail&&eval("debugger"),this.harness.breakOnFail))throw a=Siesta.Resource("Siesta.Test"),this.finalize(!0),a.get("testFailedAndAborted");},getSource:function(){return this.contentManager.getContentOf(this.url)},getSourceLine:function(){try{throw Error();}catch(a){if(a.stack){var b=a.stack.match(this.urlExtractRegex());
if(b)return b[1]}return null}},getStartTestAnchor:function(){return this.startTestAnchor},getExceptionCatcher:function(){return this.exceptionCatcher},getTestErrorClass:function(){return this.testErrorClass},processCallbackFromTest:function(a,b,c){var d=this;if(!a)return!0;if(this.transparentEx)a.apply(c||this.global,b||[]);else{var e=this.getExceptionCatcher()(function(){a.apply(c||d.global,b||[])});if(e)return this.failWithException(e),!1}return!0},getStackTrace:function(a){if(Object(a)!==a||!a.stack)return null;
var b=(a.stack+"").split("\n");a+="";for(var c=Siesta.Resource("Siesta.Test"),d=[],e,f=0;f<b.length;f++)if(e=b[f]){if(!f)if(e!=a)d.push(a);else{d.push(e);continue}e=/@(.*?):(\d+):(\d+)$/.exec(e)||/\((.*?):(\d+):(\d+)\)$/.exec(e)||/at (.*?):(\d+):(\d+)$/.exec(e)||/(.*?):(\d+):(\d+)$/.exec(e);if(!e)return null;d.push("    "+c.get("atLine")+" "+e[2]+(e[3]?", "+c.get("character")+" "+e[3]:"")+", "+c.get("of")+" "+e[1])}return d.length?d:null},formatSourceLine:function(a){var b=Siesta.Resource("Siesta.Test");
return a?b.get("atLine")+" "+a+" "+b.get("of")+" "+this.url:""},appendSpaces:function(a,b){for(var c="";b--;)c+=" ";return a+c},eachAssertion:function(a,b){b=b||this;this.getResults().each(function(c){c instanceof Siesta.Result.Assertion&&a.call(b,c)})},eachSubTest:function(a,b){b=b||this;this.getResults().each(function(c){if(c instanceof Siesta.Result.SubTest&&!1===a.call(b,c.test))return!1})},eachChildTest:function(a,b){b=b||this;this.getResults().eachChild(function(c){if(c instanceof Siesta.Result.SubTest&&
!1===a.call(b,c.test))return!1})},ok:function(a,b){var c=Siesta.Resource("Siesta.Test");a?this.pass(b,{descTpl:c.get("isTruthy"),value:a}):this.fail(b,{assertionName:"ok",got:a,annotation:c.get("needTruthy")})},notok:function(){this.notOk.apply(this,arguments)},notOk:function(a,b){var c=Siesta.Resource("Siesta.Test");a?this.fail(b,{assertionName:"notOk",got:a,annotation:c.get("needFalsy")}):this.pass(b,{descTpl:c.get("isFalsy"),value:a})},is:function(a,b,c){var d=Siesta.Resource("Siesta.Test");b&&
a instanceof this.global.Date?this.isDateEqual(a,b,c):this.compareObjects(a,b,!1,!0)?this.pass(c,{descTpl:d.get("isEqualTo"),got:a,expected:b}):this.fail(c,{assertionName:"is",got:a,need:b})},isnot:function(){this.isNot.apply(this,arguments)},isnt:function(){this.isNot.apply(this,arguments)},isNot:function(a,b,c){var d=Siesta.Resource("Siesta.Test");this.compareObjects(a,b,!1,!0)?this.fail(c,{assertionName:"isnt",got:a,need:b,needDesc:d.get("needNot")}):this.pass(c,{descTpl:d.get("isNotEqualTo"),
got:a,expected:b})},isStrict:function(a,b,c){var d=Siesta.Resource("Siesta.Test");this.compareObjects(a,b,!0,!0)?this.pass(c,{descTpl:d.get("isStrictlyEqual"),got:a,expected:b}):this.fail(c,{assertionName:"isStrict",got:a,need:b,needDesc:d.get("needStrictly")})},isntStrict:function(){this.isNotStrict.apply(this,arguments)},isNotStrict:function(a,b,c){var d=Siesta.Resource("Siesta.Test");this.compareObjects(a,b,!0,!0)?this.fail(c,{assertionName:"isntStrict",got:a,need:b,needDesc:d.get("needStrictlyNot")}):
this.pass(c,{descTpl:d.get("isStrictlyNotEqual"),got:a,expected:b})},wait:function(a,b){var c=Siesta.Resource("Siesta.Test");if(this.waitTitles.hasOwnProperty(a))throw Error(c.get("alreadyWaiting")+" ["+a+"]");return this.waitTitles[a]=this.beginAsync(b)},endWait:function(a){var b=Siesta.Resource("Siesta.Test");if(!this.waitTitles.hasOwnProperty(a))throw Error(b.get("noOngoingWait")+" ["+a+"]");this.endAsync(this.waitTitles[a]);delete this.waitTitles[a]},beginAsync:function(a,b){a=a||this.defaultTimeout;
a>this.getMaximalTimeout()&&this.fireEvent("maxtimeoutchanged",a);var c=Siesta.Resource("Siesta.Test"),d=this,e=this.originalSetTimeout,f=this.timeoutsCount.counter++,e=e(function(){d.hasAsyncFrame(f)&&(b&&b.call(d,d)||d.fail(c.get("noMatchingEndAsync")+" "+a+" "+Siesta.Resource("Siesta.Test.More","ms")),d.endAsync(f))},a);this.timeoutIds[f]=e;return f},timeoutIdToIndex:function(a){return"object"==typeof a?a.__index:this.idsToIndex[a]},hasAsyncFrame:function(a){return this.timeoutIds.hasOwnProperty(a)},
hasAsyncFrameByTimeoutId:function(a){return this.timeoutIds.hasOwnProperty(this.timeoutIdToIndex(a))},endAsync:function(a){var b=this.originalSetTimeout,c=this.originalClearTimeout||this.global.clearTimeout,d=0,e=Siesta.Resource("Siesta.Test");null==a&&Joose.O.each(this.timeoutIds,function(b,c){a=c;if(d++)throw Error(e.get("endAsyncMisuse"));});c(this.timeoutIds[a]);delete this.timeoutIds[a];var f=this;this.processed&&!this.isFinished()&&b(function(){f.finalize()},1)},clearTimeouts:function(){var a=
this.originalClearTimeout;Joose.O.each(this.timeoutIds,function(b,c){a(b)});this.timeoutIds={}},processSubTestConfig:function(a){return Joose.O.extend({trait:Siesta.Test.Sub,parent:this,isTodo:this.isTodo,transparentEx:this.transparentEx,waitForTimeout:this.waitForTimeout,waitForPollInterval:this.waitForPollInterval,defaultTimeout:this.defaultTimeout,timeout:this.subTestTimeout,subTestTimeout:this.subTestTimeout,global:this.global,url:this.url,scopeProvider:this.scopeProvider,harness:this.harness,
generation:this.generation,launchId:this.launchId,overrideSetTimeout:this.overrideSetTimeout,originalSetTimeout:this.originalSetTimeout,originalClearTimeout:this.originalClearTimeout,timeoutsCount:this.timeoutsCount,autoCheckGlobals:!1,needToCleanup:!1},a)},getSubTest:function(a,b,c){var d,e=Siesta.Resource("Siesta.Test");2==arguments.length||3==arguments.length?d={name:a,run:b,timeout:c}:1==arguments.length&&"Function"==this.typeOf(a)&&(d={name:"Sub test",run:a});d=d||a||{};null==d.timeout&&delete d.timeout;
var f=d.name;if(!d.run)throw this.failWithException(e.get("codeBodyMissingForSubTest")+" ["+f+"]"),Error(e.get("codeBodyMissingForSubTest")+" ["+f+"]");if(!d.run.length)throw this.failWithException(e.get("codeBodyMissingTestArg").replace("{name}",f)),Error(e.get("codeBodyMissingTestArg").replace("{name}",f));return new (d.meta||this.constructor)(this.processSubTestConfig(d))},launchSubTest:function(a,b){var c=this,d=Siesta.Resource("Siesta.Test"),e=a.timeout||this.subTestTimeout,f=this.beginAsync(e,
function(){c.fail(d.get("Subtest")+" "+(a.name?"["+a.name+"]":"")+" "+d.get("failedToFinishWithin")+" "+e+" "+Siesta.Resource("Siesta.Test.More","ms"));c.restoreTimeoutOverrides();g.remove();a.finalize(!0);b&&b(a);return!0}),g=a.on("testfinalize",function(){c.endAsync(f);c.restoreTimeoutOverrides();b&&b(a)});this.addResult(a.getResults());a.start()},todo:function(a,b,c){"Function"==this.typeOf(a)&&(a=[b,b=a][0]);a=this.getSubTest({name:a,run:b,isTodo:!0,transparentEx:!1});this.launchSubTest(a,c)},
snooze:function(a,b,c){var d=Siesta.Resource("Siesta.Test");new Date>new Date(a)?b.call(this.global,this):this.todo(d.get("Snoozed until")+" "+new Date(a)+": "+(c||""),b)},subTest:function(a,b,c,d){a=this.getSubTest({name:a||Siesta.Resource("Siesta.Test","Subtest"),timeout:d,run:b});this.launchSubTest(a,c);return a},stringifyException:function(a,b){var c=a+"",d=(b||this.getStackTrace(a)||[]).join("\n");-1==d.indexOf(c)&&(d=c+d);return d},failWithException:function(a){var b=Siesta.Resource("Siesta.Test");
this.failed=!0;this.failedException=a+"";this.failedExceptionType=this.typeOf(a);var c=this.getStackTrace(a);this.addResult(new Siesta.Result.Assertion({isException:!0,exceptionType:this.failedExceptionType,passed:!1,description:(this.parent?b.get("Subtest")+" `"+this.name+"`":b.get("Test")+" ")+" "+b.get("threwException"),annotation:this.stringifyException(a,c)}));this.fireEvent("testfailedwithexception",this,a,c);this.finalize(!0)},restoreTimeoutOverrides:function(){this.overrideSetTimeout&&(this.global.setTimeout=
this.overrideForSetTimeout,this.global.clearTimeout=this.overrideForClearTimeout)},start:function(a){var b=this,c=Siesta.Resource("Siesta.Test");if(this.startDate)throw c.get("testAlreadyStarted");this.startDate=new Date-0;this.fireEvent("teststart",this);if(a&&a.length)Joose.A.each(a,function(a){if(a.isException)return b.failWithException(a.message),!1;b.fail(a.message)}),b.finalize(!0);else if(this.parent||this.reusingSandbox)this.launch();else{var d,e=function(a){var d=!1,e=setTimeout(function(){d=
!0;b.launch(c.get("setupTookTooLong"))},b.isReadyTimeout);b.setup(function(){d||(clearTimeout(e),b.launch(a))},function(c){d||(clearTimeout(e),b.launch(a||c))})},f=b.isReady();if(f.ready)e();else var g=setTimeout(function(){clearInterval(k);e(d)},b.isReadyTimeout),k=setInterval(function(){f=b.isReady();f.ready?(clearInterval(k),clearTimeout(g),e()):d=f.reason||d},100)}},setup:function(a,b){a.call(this)},tearDown:function(a,b){a.call(this)},earlySetup:function(a,b){a.call(this)},cleanupContextBeforeStart:function(){var a=
this.global;this.forEachUnexpectedGlobal(function(b){try{delete a[b]}catch(c){}})},clearAsyncFrameGlobally:function(a){for(var b=this;b.parent;)b=b.parent;b.eachSubTest(function(b){if(b.hasAsyncFrameByTimeoutId(a))return b.overrideForClearTimeout(a),!1})},launch:function(a){if(a){var b=Siesta.Resource("Siesta.Test");this.fail(b.get("errorBeforeTestStarted"),{annotation:a})}var c=this,d=this.global;a=this.scopeProvider;var e=this.originalSetTimeout,f=this.originalClearTimeout;this.overrideSetTimeout&&
(this.reusingSandbox||a.runCode("var setTimeout, clearTimeout;"),d.setTimeout=this.overrideForSetTimeout=function(a,b){var d=c.timeoutsCount.counter++,g=e(function(){f(g);delete c.timeoutIds[d];c.processed&&!c.isFinished()&&e(function(){c.finalize()},1);a()},b);"object"==typeof g?g.__index=d:c.idsToIndex[g]=d;return c.timeoutIds[d]=g},d.clearTimeout=this.overrideForClearTimeout=function(a){null!=a&&(c.hasAsyncFrameByTimeoutId(a)?(f(a),a=c.timeoutIdToIndex(a),null!=a&&delete c.timeoutIds[a],c.processed&&
!c.isFinished()&&e(function(){c.finalize()},1)):c.clearAsyncFrameGlobally(a))});this.needToCleanup&&(a.beforeCleanupCallback=function(){c.isFinished()||c.finalize(!0);c.overrideSetTimeout&&(d.setTimeout=e,d.clearTimeout=f);d=e=f=null;c.eachSubTest(function(a){a.cleanup()})});this.reusingSandbox&&(this.sandboxCleanup&&!this.parent)&&this.cleanupContextBeforeStart();var g=this.run;if(this.transparentEx)g(c);else var k=this.getExceptionCatcher()(function(){g(c)});this.afterLaunch(k)},cleanup:function(){this.scopeProvider=
this.startTestAnchor=this.exceptionCatcher=this.testErrorClass=this.global=this.run=this.originalSetTimeout=this.originalClearTimeout=this.overrideForSetTimeout=this.overrideForClearTimeout=null;this.purgeListeners()},afterLaunch:function(a){a?this.failWithException(a):this.finalize()},finalize:function(a){var b=this,c=Siesta.Resource("Siesta.Test");if(!b.finalizationStarted&&!b.isFinished())if(b.processed=!0,a&&(b.clearTimeouts(),b.eachChildTest(function(a){a.finalize(!0)})),Joose.O.isEmpty(b.timeoutIds)){if(!b.needDone&&
!b.isDone){b.fireEvent("beforetestfinalizeearly",b);if(!Joose.O.isEmpty(b.timeoutIds))if(a)b.clearTimeouts();else return;b.onBeforeTestFinalize();b.fireEvent("beforetestfinalize",b)}b.finalizationStarted=!0;var d=function(a){a&&b.fail(a);b.endDate=new Date-0;b.parent||b.addResult(new Siesta.Result.Summary({isFailed:b.isFailed(),description:b.getSummaryMessage()}));b.onTestFinalize();b.fireEvent("testfinalize",b);b.fireEvent("testendbubbling",b);b.callback&&b.callback();b.callback=null};if(b.parent||
b.reusingSandbox)d();else{a=b.originalSetTimeout;var e=b.originalClearTimeout,f=!1,g=a(function(){f=!0;d(c.get("testTearDownTimeout"))},b.isReadyTimeout);b.tearDown(function(){e(g);f||d()},function(a){e(g);f||d(a)})}}else!b.__timeoutWarning&&(b.overrideSetTimeout&&b.lastActivityDate&&new Date-b.lastActivityDate>2*b.defaultTimeout)&&(b.diag(c.get("testStillRunning")),b.warn(c.get("testNotFinalized").replace("{url}",b.url)),b.__timeoutWarning=!0)},onBeforeTestFinalize:function(){},onTestFinalize:function(){},
getSummaryMessage:function(a){var b=[],c=this.getPassCount(),d=this.getFailCount(),e=this.assertPlanned,f=d+c;b.push("Passed: "+c);b.push("Failed: "+d);this.failed||(null!=e?(f<e&&b.push("Looks like you planned "+e+" tests, but ran only "+f),f>e&&b.push("Looks like you planned "+e+" tests, but ran "+(f-e)+" extra tests, "+f+" total."),f!=e||d||b.push("All tests passed")):(c=Siesta.Resource("Siesta.Test"),this.isDoneCorrectly()||b.push(c.get("missingDoneCall")),this.isDoneCorrectly()&&!d&&b.push(c.get("allTestsPassed"))));
return a?b.join(a):b},done:function(a){var b=this;if(a){var c=this.beginAsync(),d=this.originalSetTimeout;d(function(){b.endAsync(c);b.done()},a)}else this.fireEvent("beforetestfinalizeearly"),this.fireEvent("beforetestfinalize"),this.isDone=!0,this.processed&&this.finalize()},isDoneCorrectly:function(){return!this.needDone||this.isDone},getAssertionCount:function(a){var b=0;this.eachAssertion(function(c){a&&c.isTodo||b++});return b},getPassCount:function(a){if(null!=this.$passCount&&!a)return this.$passCount;
...
(function(a,b){function c(a,c,d){if(d===b&&1===a.nodeType)if(d="data-"+c.replace(Xa,"$1-$2").toLowerCase(),d=a.getAttribute(d),"string"===typeof d){try{d="true"===d?!0:"false"===d?!1:"null"===d?null:h.isNaN(d)?Ya.test(d)?h.parseJSON(d):d:parseFloat(d)}catch(e){}h.data(a,c,d)}else d=b;return d}function d(a){for(var b in a)if("toJSON"!==b)return!1;return!0}function e(a,c,d){var e=c+"defer",f=c+"queue",g=c+"mark",k=h.data(a,e,b,!0);!k||("queue"!==d&&h.data(a,f,b,!0)||"mark"!==d&&h.data(a,g,b,!0))||setTimeout(function(){h.data(a,
...
"(\\.|$)"));a.liveFired=this;var t=f.live.slice(0);for(k=0;k<t.length;k++)f=t[k],f.origType.replace(ha,"")===a.type?e.push(f.selector):t.splice(k--,1);e=h(a.target).closest(e,a.currentTarget);l=0;for(m=e.length;l<m;l++)for(n=e[l],k=0;k<t.length;k++)if(f=t[k],n.selector===f.selector&&(!p||p.test(f.namespace))&&!n.elem.disabled){g=n.elem;d=null;if("mouseenter"===f.preType||"mouseleave"===f.preType)a.type=f.preType,(d=h(a.relatedTarget).closest(f.selector)[0])&&h.contains(g,d)&&(d=g);d&&d===g||q.push({elem:g,
handleObj:f,level:n.level})}l=0;for(m=q.length;l<m;l++){e=q[l];if(c&&e.level>c)break;a.currentTarget=e.elem;a.data=e.handleObj.data;a.handleObj=e.handleObj;p=e.handleObj.origHandler.apply(e.elem,arguments);if(!1===p||a.isPropagationStopped())if(c=e.level,!1===p&&(b=!1),a.isImmediatePropagationStopped())break}return b}}function m(a,b){return(a&&"*"!==a?a+".":"")+b.replace(Za,"`").replace($a,"&")}function n(a,b,c){b=b||0;if(h.isFunction(b))return h.grep(a,function(a,d){return!!b.call(a,d,a)===c});if(b.nodeType)return h.grep(a,
function(a,d){return a===b===c});if("string"===typeof b){var d=h.grep(a,function(a){return 1===a.nodeType});if(ab.test(b))return h.filter(b,d,!c);b=h.filter(b,d)}return h.grep(a,function(a,d){return 0<=h.inArray(a,b)===c})}function p(a,b){if(1===b.nodeType&&h.hasData(a)){var c=h.expando,d=h.data(a),e=h.data(b,d);if(d=d[c]){var f=d.events,e=e[c]=h.extend({},d);if(f){delete e.handle;e.events={};for(var g in f)for(c=0,d=f[g].length;c<d;c++)h.event.add(b,g+(f[g][c].namespace?".":"")+f[g][c].namespace,
...
!1}var u=a.document,fb=a.navigator,gb=a.location,h=function(){function c(){if(!d.isReady){try{u.documentElement.doScroll("left")}catch(a){setTimeout(c,1);return}d.ready()}}var d=function(a,b){return new d.fn.init(a,b,h)},e=a.jQuery,f=a.$,h,g=/^(?:[^<]*(<[\w\W]+>)[^>]*$|#([\w\-]*)$)/,k=/\S/,l=/^\s+/,m=/\s+$/,n=/\d/,p=/^<(\w+)\s*\/?>(?:<\/\1>)?$/,q=/^[\],:{}\s]*$/,t=/\\(?:["\\\/bfnrt]|u[0-9a-fA-F]{4})/g,s=/"[^"\\\n\r]*"|true|false|null|-?\d+(?:\.\d*)?(?:[eE][+\-]?\d+)?/g,v=/(?:^|:|,)(?:\s*\[)+/g,x=
/(webkit)[ \/]([\w.]+)/,y=/(opera)(?:.*version)?[ \/]([\w.]+)/,w=/(msie) ([\w.]+)/,D=/(mozilla)(?:.*? rv:([\w.]+))?/,hb=/-([a-z])/ig,C=function(a,b){return b.toUpperCase()},la=fb.userAgent,ca,da,V,ib=Object.prototype.toString,ma=Object.prototype.hasOwnProperty,F=Array.prototype.push,z=Array.prototype.slice,A=String.prototype.trim,ya=Array.prototype.indexOf,za={};d.fn=d.prototype={constructor:d,init:function(a,c,e){var r;if(!a)return this;if(a.nodeType)return this.context=this[0]=a,this.length=1,this;
...
n=a+"mark",p;g--;)if(p=h.data(f[g],l,b,!0)||(h.data(f[g],m,b,!0)||h.data(f[g],n,b,!0))&&h.data(f[g],l,h._Deferred(),!0))k++,p.done(d);d();return e.promise()}});var Ba=/[\n\t\r]/g,oa=/\s+/,jb=/\r/g,kb=/^(?:button|input)$/i,lb=/^(?:button|input|object|select|textarea)$/i,mb=/^a(?:rea)?$/i,Ca=/^(?:autofocus|autoplay|async|checked|controls|defer|disabled|hidden|loop|multiple|open|readonly|required|scoped|selected)$/i,nb=/\:|^on/,K,Da;h.fn.extend({attr:function(a,b){return h.access(this,a,b,!0,h.attr)},
...
function(){h.valHooks[this]={get:function(a){return null===a.getAttribute("value")?"on":a.value}}});h.each(["radio","checkbox"],function(){h.valHooks[this]=h.extend(h.valHooks[this],{set:function(a,b){if(h.isArray(b))return a.checked=0<=h.inArray(h(a).val(),b)}})});var ha=/\.(.*)$/,pa=/^(?:textarea|input|select)$/i,Za=/\./g,$a=/ /g,ob=/[^\w\s.|`]/g,pb=function(a){return a.replace(ob,"\\$&")};h.event={add:function(a,c,d,e){if(3!==a.nodeType&&8!==a.nodeType){if(!1===d)d=f;else if(!d)return;var g,k;
d.handler&&(g=d,d=g.handler);d.guid||(d.guid=h.guid++);if(k=h._data(a)){var l=k.events,m=k.handle;l||(k.events=l={});m||(k.handle=m=function(a){return"undefined"===typeof h||a&&h.event.triggered===a.type?b:h.event.handle.apply(m.elem,arguments)});m.elem=a;c=c.split(" ");for(var n,p=0,q;n=c[p++];){k=g?h.extend({},g):{handler:d,data:e};-1<n.indexOf(".")?(q=n.split("."),n=q.shift(),k.namespace=q.slice(0).sort().join(".")):(q=[],k.namespace="");k.type=n;k.guid||(k.guid=d.guid);var t=l[n],s=h.event.special[n]||
{};t||(t=l[n]=[],s.setup&&!1!==s.setup.call(a,e,q,m)||(a.addEventListener?a.addEventListener(n,m,!1):a.attachEvent&&a.attachEvent("on"+n,m)));s.add&&(s.add.call(a,k),k.handler.guid||(k.handler.guid=d.guid));t.push(k);h.event.global[n]=!0}a=null}}},global:{},remove:function(a,c,d,e){if(3!==a.nodeType&&8!==a.nodeType){!1===d&&(d=f);var g,k,l=0,m,n,p,q,t,s,v=h.hasData(a)&&h._data(a),x=v&&v.events;if(v&&x)if(c&&c.type&&(d=c.handler,c=c.type),!c||"string"===typeof c&&"."===c.charAt(0))for(g in c=c||"",
x)h.event.remove(a,g+c);else{for(c=c.split(" ");g=c[l++];)if(q=g,m=0>g.indexOf("."),n=[],m||(n=g.split("."),g=n.shift(),p=RegExp("(^|\\.)"+h.map(n.slice(0).sort(),pb).join("\\.(?:.*\\.)?")+"(\\.|$)")),t=x[g])if(d){q=h.event.special[g]||{};for(k=e||0;k<t.length;k++)if(s=t[k],d.guid===s.guid){if(m||p.test(s.namespace))null==e&&t.splice(k--,1),q.remove&&q.remove.call(a,s);if(null!=e)break}if(0===t.length||null!=e&&1===t.length)q.teardown&&!1!==q.teardown.call(a,n)||h.removeEvent(a,g,v.handle),delete x[g]}else for(k=
0;k<t.length;k++)if(s=t[k],m||p.test(s.namespace))h.event.remove(a,q,s.handler,k),t.splice(k--,1);if(h.isEmptyObject(x)){if(c=v.handle)c.elem=null;delete v.events;delete v.handle;h.isEmptyObject(v)&&h.removeData(a,b,!0)}}}},customEvent:{getData:!0,setData:!0,changeData:!0},trigger:function(c,d,e,f){var g=c.type||c,k=[],l;0<=g.indexOf("!")&&(g=g.slice(0,-1),l=!0);0<=g.indexOf(".")&&(k=g.split("."),g=k.shift(),k.sort());if(e&&!h.event.customEvent[g]||h.event.global[g]){c="object"===typeof c?c[h.expando]?
...
typeof b.getElementsByTagName?b.getElementsByTagName("*"):[]);return{set:d,expr:a}};n.filter=function(a,c,d,e){for(var f,g,h=a,k=[],r=c,l=c&&c[0]&&n.isXML(c[0]);a&&c.length;){for(var G in p.filter)if(null!=(f=p.leftMatch[G].exec(a))&&f[2]){var N,B,m=p.filter[G];B=f[1];g=!1;f.splice(1,1);if("\\"!==B.substr(B.length-1)){r===k&&(k=[]);if(p.preFilter[G])if(f=p.preFilter[G](f,r,d,k,e,l),!f)g=N=!0;else if(!0===f)continue;if(f)for(var aa=0;null!=(B=r[aa]);aa++)if(B){N=m(B,f,aa,r);var E=e^!!N;d&&null!=N?
E?g=!0:r[aa]=!1:E&&(k.push(B),g=!0)}if(N!==b){d||(r=k);a=a.replace(p.match[G],"");if(!g)return[];break}}}if(a===h)if(null==g)n.error(a);else break;h=a}return r};n.error=function(a){throw"Syntax error, unrecognized expression: "+a;};var p=n.selectors={order:["ID","NAME","TAG"],match:{ID:/#((?:[\w\u00c0-\uFFFF\-]|\\.)+)/,CLASS:/\.((?:[\w\u00c0-\uFFFF\-]|\\.)+)/,NAME:/\[name=['"]*((?:[\w\u00c0-\uFFFF\-]|\\.)+)['"]*\]/,ATTR:/\[\s*((?:[\w\u00c0-\uFFFF\-]|\\.)+)\s*(?:(\S?=)\s*(?:(['"])(.*?)\3|(#?(?:[\w\u00c0-\uFFFF\-]|\\.)*)|)|)\s*\]/,
...
b){h.fn[a]=function(c,d){var e=h.map(this,b,c),f=tb.call(arguments);qb.test(a)||(d=c);d&&"string"===typeof d&&(e=h.filter(d,e));e=1<this.length&&!ub[a]?h.unique(e):e;(1<this.length||sb.test(d))&&rb.test(a)&&(e=e.reverse());return this.pushStack(e,a,f.join(","))}});h.extend({filter:function(a,b,c){c&&(a=":not("+a+")");return 1===b.length?h.find.matchesSelector(b[0],a)?[b[0]]:[]:h.find.matches(a,b)},dir:function(a,c,d){var e=[];for(a=a[c];a&&9!==a.nodeType&&(d===b||1!==a.nodeType||!h(a).is(d));)1===
a.nodeType&&e.push(a),a=a[c];return e},nth:function(a,b,c,d){b=b||1;for(d=0;a&&(1!==a.nodeType||++d!==b);a=a[c]);return a},sibling:function(a,b){for(var c=[];a;a=a.nextSibling)1===a.nodeType&&a!==b&&c.push(a);return c}});var vb=/ jQuery\d+="(?:\d+|null)"/g,ra=/^\s+/,Ia=/<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/ig,Ja=/<([\w:]+)/,wb=/<tbody/i,xb=/<|&#?\w+;/,Ka=/<(?:script|object|embed|option|style)/i,La=/checked\s*(?:[^=]|=\s*.checked.)/i,yb=/\/(java|ecma)script/i,bb=/^\s*<!(?:\[CDATA\[|\-\-)/,
...
b?a:b;return this.map(function(){return h.clone(this,a,b)})},html:function(a){if(a===b)return this[0]&&1===this[0].nodeType?this[0].innerHTML.replace(vb,""):null;if("string"!==typeof a||Ka.test(a)||!h.support.leadingWhitespace&&ra.test(a)||H[(Ja.exec(a)||["",""])[1].toLowerCase()])h.isFunction(a)?this.each(function(b){var c=h(this);c.html(a.call(this,b,c.html()))}):this.empty().append(a);else{a=a.replace(Ia,"<$1></$2>");try{for(var c=0,d=this.length;c<d;c++)1===this[c].nodeType&&(h.cleanData(this[c].getElementsByTagName("*")),
...
typeof b.createElement&&(b=b.ownerDocument||b[0]&&b[0].ownerDocument||u);for(var e=[],f,g=0,k;null!=(k=a[g]);g++)if("number"===typeof k&&(k+=""),k){if("string"===typeof k)if(xb.test(k)){k=k.replace(Ia,"<$1></$2>");f=(Ja.exec(k)||["",""])[1].toLowerCase();var l=H[f]||H._default,m=l[0],n=b.createElement("div");for(n.innerHTML=l[1]+k+l[2];m--;)n=n.lastChild;if(!h.support.tbody)for(m=wb.test(k),l="table"!==f||m?"<table>"!==l[1]||m?[]:n.childNodes:n.firstChild&&n.firstChild.childNodes,f=l.length-1;0<=
f;--f)h.nodeName(l[f],"tbody")&&!l[f].childNodes.length&&l[f].parentNode.removeChild(l[f]);!h.support.leadingWhitespace&&ra.test(k)&&n.insertBefore(b.createTextNode(ra.exec(k)[0]),n.firstChild);k=n.childNodes}else k=b.createTextNode(k);var p;if(!h.support.appendChecked)if(k[0]&&"number"===typeof(p=k.length))for(f=0;f<p;f++)v(k[f]);else v(k);k.nodeType?e.push(k):e=h.merge(e,k)}if(c)for(a=function(a){return!a.type||yb.test(a.type)},g=0;e[g];g++)!d||!h.nodeName(e[g],"script")||e[g].type&&"text/javascript"!==
...
e&&Cb.test(d)&&(d=+d.replace(Db,"")+parseFloat(h.css(a,c)),e="number"),"number"!==e||h.cssNumber[g]||(d+="px"),l&&"set"in l&&(d=l.set(a,d))===b)))try{k[c]=d}catch(m){}}else return l&&"get"in l&&(f=l.get(a,!1,e))!==b?f:k[c]}},css:function(a,c,d){var e,f;c=h.camelCase(c);f=h.cssHooks[c];c=h.cssProps[c]||c;"cssFloat"===c&&(c="float");if(f&&"get"in f&&(e=f.get(a,!0,d))!==b)return e;if(P)return P(a,c)},swap:function(a,b,c){var d={},e;for(e in b)d[e]=a.style[e],a.style[e]=b[e];c.call(a);for(e in b)a.style[e]=
d[e]}});h.curCSS=h.css;h.each(["height","width"],function(a,b){h.cssHooks[b]={get:function(a,c,d){var e;if(c){if(0!==a.offsetWidth)return x(a,b,d);h.swap(a,Eb,function(){e=x(a,b,d)});return e}},set:function(a,b){if(Na.test(b)){if(b=parseFloat(b),0<=b)return b+"px"}else return b}}});h.support.opacity||(h.cssHooks.opacity={get:function(a,b){return zb.test((b&&a.currentStyle?a.currentStyle.filter:a.style.filter)||"")?parseFloat(RegExp.$1)/100+"":b?"1":""},set:function(a,b){var c=a.style,d=a.currentStyle;
c.zoom=1;var e=h.isNaN(b)?"":"alpha(opacity="+100*b+")",d=d&&d.filter||c.filter||"";c.filter=Ma.test(d)?d.replace(Ma,e):d+" "+e}});h(function(){h.support.reliableMarginRight||(h.cssHooks.marginRight={get:function(a,b){var c;h.swap(a,{display:"inline-block"},function(){c=b?P(a,"margin-right","marginRight"):a.style.marginRight});return c}})});u.defaultView&&u.defaultView.getComputedStyle&&(Oa=function(a,c){var d,e;c=c.replace(Ab,"-$1").toLowerCase();if(!(e=a.ownerDocument.defaultView))return b;if(e=
e.getComputedStyle(a,null))d=e.getPropertyValue(c),""!==d||h.contains(a.ownerDocument.documentElement,a)||(d=h.style(a,c));return d});u.documentElement.currentStyle&&(Pa=function(a,b){var c,d=a.currentStyle&&a.currentStyle[b],e=a.runtimeStyle&&a.runtimeStyle[b],f=a.style;!Na.test(d)&&Bb.test(d)&&(c=f.left,e&&(a.runtimeStyle.left=a.currentStyle.left),f.left="fontSize"===b?"1em":d||0,d=f.pixelLeft+"px",f.left=c,e&&(a.runtimeStyle.left=e));return""===d?"auto":d});P=Oa||Pa;h.expr&&h.expr.filters&&(h.expr.filters.hidden=
function(a){var b=a.offsetHeight;return 0===a.offsetWidth&&0===b||!h.support.reliableHiddenOffsets&&"none"===(a.style.display||h.css(a,"display"))},h.expr.filters.visible=function(a){return!h.expr.filters.hidden(a)});var Fb=/%20/g,eb=/\[\]$/,Qa=/\r?\n/g,Gb=/#.*$/,Hb=/^(.*?):[ \t]*([^\r\n]*)\r?$/mg,Ib=/^(?:color|date|datetime|email|hidden|month|number|password|range|search|tel|text|time|url|week)$/i,Jb=/^(?:GET|HEAD)$/,Kb=/^\/\//,Ra=/\?/,Lb=/<script\b[^<]*(?:(?!<\/script>)<[^<]*)*<\/script>/gi,Mb=
/^(?:select|textarea)/i,va=/\s+/,Nb=/([?&])_=[^&]*/,Sa=/^([\w\+\.\-]+:)(?:\/\/([^\/?#:]*)(?::(\d+))?)?/,Ta=h.fn.load,ia={},Ua={},J,L;try{J=gb.href}catch(Tb){J=u.createElement("a"),J.href="",J=J.href}L=Sa.exec(J.toLowerCase())||[];h.fn.extend({load:function(a,c,d){if("string"!==typeof a&&Ta)return Ta.apply(this,arguments);if(!this.length)return this;var e=a.indexOf(" ");if(0<=e){var f=a.slice(e,a.length);a=a.slice(0,e)}e="GET";c&&(h.isFunction(c)?(d=c,c=b):"object"===typeof c&&(c=h.param(c,h.ajaxSettings.traditional),
e="POST"));var g=this;h.ajax({url:a,type:e,dataType:"html",data:c,complete:function(a,b,c){c=a.responseText;a.isResolved()&&(a.done(function(a){c=a}),g.html(f?h("<div>").append(c.replace(Lb,"")).find(f):c));d&&g.each(d,[c,b,a])}});return this},serialize:function(){return h.param(this.serializeArray())},serializeArray:function(){return this.map(function(){return this.elements?h.makeArray(this.elements):this}).filter(function(){return this.name&&!this.disabled&&(this.checked||Mb.test(this.nodeName)||
Ib.test(this.type))}).map(function(a,b){var c=h(this).val();return null==c?null:h.isArray(c)?h.map(c,function(a,c){return{name:b.name,value:a.replace(Qa,"\r\n")}}):{name:b.name,value:c.replace(Qa,"\r\n")}}).get()}});h.each("ajaxStart ajaxStop ajaxComplete ajaxError ajaxSuccess ajaxSend".split(" "),function(a,b){h.fn[b]=function(a){return this.bind(b,a)}});h.each(["get","post"],function(a,c){h[c]=function(a,d,e,f){h.isFunction(d)&&(f=f||e,e=d,d=b);return h.ajax({type:c,url:a,data:d,success:e,dataType:f})}});
...
accepts:{xml:"application/xml, text/xml",html:"text/html",text:"text/plain",json:"application/json, text/javascript","*":"*/*"},contents:{xml:/xml/,html:/html/,json:/json/},responseFields:{xml:"responseXML",text:"responseText"},converters:{"* text":a.String,"text html":!0,"text json":h.parseJSON,"text xml":h.parseXML}},ajaxPrefilter:y(ia),ajaxTransport:y(Ua),ajax:function(a,c){function d(a,c,r,p){if(2!==y){y=2;x&&clearTimeout(x);v=b;t=p||"";C.readyState=a?4:0;var G,B,q;if(r){p=e;var s=C,u=p.contents,
D=p.dataTypes,F=p.responseFields,z,A,O,H;for(A in F)A in r&&(s[F[A]]=r[A]);for(;"*"===D[0];)D.shift(),z===b&&(z=p.mimeType||s.getResponseHeader("content-type"));if(z)for(A in u)if(u[A]&&u[A].test(z)){D.unshift(A);break}if(D[0]in r)O=D[0];else{for(A in r){if(!D[0]||p.converters[A+" "+D[0]]){O=A;break}H||(H=A)}O=O||H}O?(O!==D[0]&&D.unshift(O),r=r[O]):r=void 0}else r=b;if(200<=a&&300>a||304===a){if(e.ifModified){if(z=C.getResponseHeader("Last-Modified"))h.lastModified[n]=z;if(z=C.getResponseHeader("Etag"))h.etag[n]=
...
" to "));!0!==R&&(r=R?R(r):T(S(r)))}}B=r;c="success";G=!0}catch(P){c="parsererror",q=P}}else if(q=c,!c||a)c="error",0>a&&(a=0);C.status=a;C.statusText=c;G?k.resolveWith(f,[B,c,C]):k.rejectWith(f,[C,c,q]);C.statusCode(m);m=b;w&&g.trigger("ajax"+(G?"Success":"Error"),[C,e,G?B:q]);l.resolveWith(f,[C,c]);w&&(g.trigger("ajaxComplete",[C,e]),--h.active||h.event.trigger("ajaxStop"))}}"object"===typeof a&&(c=a,a=b);c=c||{};var e=h.ajaxSetup({},c),f=e.context||e,g=f!==e&&(f.nodeType||f instanceof h)?h(f):
h.event,k=h.Deferred(),l=h._Deferred(),m=e.statusCode||{},n,p={},q={},t,s,v,x,u,y=0,w,F,C={readyState:0,setRequestHeader:function(a,b){if(!y){var c=a.toLowerCase();a=q[c]=q[c]||a;p[a]=b}return this},getAllResponseHeaders:function(){return 2===y?t:null},getResponseHeader:function(a){var c;if(2===y){if(!s)for(s={};c=Hb.exec(t);)s[c[1].toLowerCase()]=c[2];c=s[a.toLowerCase()]}return c===b?null:c},overrideMimeType:function(a){y||(e.mimeType=a);return this},abort:function(a){a=a||"abort";v&&v.abort(a);
d(0,a);return this}};k.promise(C);C.success=C.done;C.error=C.fail;C.complete=l.done;C.statusCode=function(a){if(a){var b;if(2>y)for(b in a)m[b]=[m[b],a[b]];else b=a[C.status],C.then(b,b)}return this};e.url=((a||e.url)+"").replace(Gb,"").replace(Kb,L[1]+"//");e.dataTypes=h.trim(e.dataType||"*").toLowerCase().split(va);null==e.crossDomain&&(u=Sa.exec(e.url.toLowerCase()),e.crossDomain=!(!u||u[1]==L[1]&&u[2]==L[2]&&(u[3]||("http:"===u[1]?80:443))==(L[3]||("http:"===L[1]?80:443))));e.data&&(e.processData&&
"string"!==typeof e.data)&&(e.data=h.param(e.data,e.traditional));D(ia,e,c,C);if(2===y)return!1;w=e.global;e.type=e.type.toUpperCase();e.hasContent=!Jb.test(e.type);w&&0===h.active++&&h.event.trigger("ajaxStart");if(!e.hasContent&&(e.data&&(e.url+=(Ra.test(e.url)?"&":"?")+e.data),n=e.url,!1===e.cache)){u=h.now();var z=e.url.replace(Nb,"$1_="+u);e.url=z+(z===e.url?(Ra.test(e.url)?"&":"?")+"_="+u:"")}(e.data&&e.hasContent&&!1!==e.contentType||c.contentType)&&C.setRequestHeader("Content-Type",e.contentType);
e.ifModified&&(n=n||e.url,h.lastModified[n]&&C.setRequestHeader("If-Modified-Since",h.lastModified[n]),h.etag[n]&&C.setRequestHeader("If-None-Match",h.etag[n]));C.setRequestHeader("Accept",e.dataTypes[0]&&e.accepts[e.dataTypes[0]]?e.accepts[e.dataTypes[0]]+("*"!==e.dataTypes[0]?", */*; q=0.01":""):e.accepts["*"]);for(F in e.headers)C.setRequestHeader(F,e.headers[F]);if(e.beforeSend&&(!1===e.beforeSend.call(f,C,e)||2===y))return C.abort(),!1;for(F in{success:1,error:1,complete:1})C[F](e[F]);if(v=D(Ua,
e,c,C)){C.readyState=1;w&&g.trigger("ajaxSend",[C,e]);e.async&&0<e.timeout&&(x=setTimeout(function(){C.abort("timeout")},e.timeout));try{y=1,v.send(p,d)}catch(A){2>status?d(-1,A):h.error(A)}}else d(-1,"No Transport");return C},param:function(a,c){var d=[],e=function(a,b){b=h.isFunction(b)?b():b;d[d.length]=encodeURIComponent(a)+"="+encodeURIComponent(b)};c===b&&(c=h.ajaxSettings.traditional);if(h.isArray(a)||a.jquery&&!h.isPlainObject(a))h.each(a,function(){e(this.name,this.value)});else for(var f in a)z(f,
a[f],c,e);return d.join("&").replace(Fb,"+")}});h.extend({active:0,lastModified:{},etag:{}});var Ob=h.now(),fa=/(\=)\?(&|$)|\?\?/i;h.ajaxSetup({jsonp:"callback",jsonpCallback:function(){return h.expando+"_"+Ob++}});h.ajaxPrefilter("json jsonp",function(b,c,d){c="application/x-www-form-urlencoded"===b.contentType&&"string"===typeof b.data;if("jsonp"===b.dataTypes[0]||!1!==b.jsonp&&(fa.test(b.url)||c&&fa.test(b.data))){var e,f=b.jsonpCallback=h.isFunction(b.jsonpCallback)?b.jsonpCallback():b.jsonpCallback,
...
e[l])}catch(m){}g.send(c.hasContent&&c.data||null);d=function(a,e){var l,m,n,p,q;try{if(d&&(e||4===g.readyState))if(d=b,k&&(g.onreadystatechange=h.noop,sa&&delete W[k]),e)4!==g.readyState&&g.abort();else{l=g.status;n=g.getAllResponseHeaders();p={};(q=g.responseXML)&&q.documentElement&&(p.xml=q);p.text=g.responseText;try{m=g.statusText}catch(B){m=""}l||!c.isLocal||c.crossDomain?1223===l&&(l=204):l=p.text?200:404}}catch(s){e||f(-1,s)}p&&f(l,m,p,n)};c.async&&4!==g.readyState?(k=++Pb,sa&&(W||(W={},h(a).unload(sa)),
W[k]=d),g.onreadystatechange=d):d()},abort:function(){d&&d(0,1)}}}});var ja={},I,U,Qb=/^(?:toggle|show|hide)$/,Rb=/^([+\-]=)?([\d+.\-]+)([a-z%]*)$/i,X,wa=[["height","marginTop","marginBottom","paddingTop","paddingBottom"],["width","marginLeft","marginRight","paddingLeft","paddingRight"],["opacity"]],ba,ta=a.webkitRequestAnimationFrame||a.mozRequestAnimationFrame||a.oRequestAnimationFrame;h.fn.extend({show:function(a,b,c){if(a||0===a)return this.animate(M("show",3),a,b,c);c=0;for(var d=this.length;c<
...
b=f?b.charCodeAt(0):0;var g=this.isTextInput(a),k=this.isEditableNode(a),l=g||k,m=this.simulateEvent(a,"keydown",$.extend({charCode:0,keyCode:e},c),!0),m=this.isEventPrevented(m);a=this.activeElement(!0,a,a);b=this.simulateEvent(a,"keypress",$.extend({charCode:b,keyCode:f?0:e},c),!1);var n=this.isEventPrevented(b);b=Siesta.Harness.Browser.FeatureSupport().supports;m||(n||e!==d.TAB)||(a=this.emulateTab(a,c.shiftKey?-1:1)||a);!n&&(l&&e!=d.TAB)&&(l=this.harness.isPhantomJS,m="value"in a?"value":"innerHTML",
f&&(l||(k&&$.browser.msie&&(f=a.innerHTML,0===f.indexOf("&nbsp;")?a.innerHTML=f.substring(6):0===f.indexOf("<br>")&&(a.innerHTML=f.substring(4))),k&&!$.browser.msie?(f=a.innerHTML,8203===f.charCodeAt(f.length-1)&&(a.innerHTML=f.substring(0,f.length-1)),a.ownerDocument.execCommand("insertText",!1,c.readableKey)):this.simulateEvent(a,"textInput",{text:c.readableKey},!0)),f=a[m].length,k=a.getAttribute("maxlength"),null!=k&&(k=Number(k)),!g&&!$.browser.msie||(b.canSimulateKeyCharacters&&!l||f!==a[m].length||
f===k)||(a[m]+=c.readableKey)),e===d.BACKSPACE&&(!b.canSimulateBackspace&&0<a[m].length)&&(g||$.browser.msie?a[m]=a[m].substring(0,a[m].length-1):a.ownerDocument.execCommand("delete")),"value"!==m||(e!==d.ENTER||b.enterSubmitsForm)||(g=this.$(a).closest("form"),f=0<g.find("[type=submit]").length,k=1===g.find("input").length,g.length&&(f||k)&&(this.isEventPrevented(this.simulateEvent(g[0],"submit",{},!0))||g[0].submit())));g=a.nodeName&&a.nodeName.toLowerCase();"a"!=g&&"button"!=g||(e!==d.ENTER||b.enterOnAnchorTriggersClick)||
...
"true"===a.contentEditable.toLowerCase()},isReadableKey:function(a){var b=Siesta.Test.Simulate.KeyCodes();return!b.isNav(a)&&!b.isSpecial(a)}}});
...
f,e));if(c=this.createEvent(b,c,a))c.synthetic=!0,this.dispatchEvent(a,b,c),d||this.fireEvent("eventsimulated",this,a,b,c);return e||c},createEvent:function(a,b,c){if((a=/^text(Input)$/.test(a)?this.createTextEvent(a,b,c):/^mouse(over|out|down|up|move|enter|leave)|contextmenu|(dbl)?click$/.test(a)||/^(ms)?pointer/i.test(a)?this.createMouseEvent(a,b,c):/^key(up|down|press)$/.test(a)?this.createKeyboardEvent(a,b,c):/^submit/.test(a)?this.createGenericEvent(a,b,c):this.createHtmlEvent(a,b,c))&&$.browser.msie&&
9<=Number($.browser.version)){var d=a.preventDefault;d&&(a.preventDefault=function(){this.$defaultPrevented=!0;return d.apply(this,arguments)})}return a},createGenericEvent:function(a,b,c){b=c.ownerDocument;if(b.createEvent&&"dispatchEvent"==this.getSimulateEventsWith())return b=b.createEvent("Events"),b.initEvent(a,!0,!0),b;if(b.createEventObject)return b.createEventObject()},createHtmlEvent:function(a,b,c){b=c.ownerDocument;if(b.createEvent&&"dispatchEvent"==this.getSimulateEventsWith())return b=
b.createEvent("HTMLEvents"),b.initEvent(a,!1,!1),b;if(b.createEventObject)return b.createEventObject()},dispatchEvent:function(a,b,c){if(a.dispatchEvent&&"dispatchEvent"==this.getSimulateEventsWith())a.dispatchEvent(c);else if(a.fireEvent)try{a.fireEvent("on"+b,c)}catch(d){}else throw"Can't dispatch event: "+b;return c}}});
...
c*Math.sin(t)),D=Math.round(n.localXY[0]+c*Math.cos(t)),z=Math.round(n.localXY[1]+c*Math.sin(t)),A=Joose.O.extend({},f);p.addStep({processor:function(){s=l.touchStart(null,null,f,m);q=l.touchStart(null,null,A,n)}});p.addAsyncStep({processor:function(a){var b=!1,c=!1;l.touchMove(s,x,y,function(){(b=!0)&&c&&a.next()},null,f);l.touchMove(q,D,z,function(){c=!0;b&&c&&a.next()},null,A)}});p.addStep({processor:function(){l.touchEnd(s,f);l.touchEnd(q,A)}});var F=l.beginAsync();p.run(function(){l.endAsync(F);
...
!0;c.ComponentQuery&&(c.ComponentQuery.pseudos.root=function(a,b){var c=0,d=a.length,l,m=[];for(b=b||0;c<d;c++)(l=a[c].up())&&l.contains&&l.contains(a[c])||0!==b&&b!==m.length||m.push(a[c]);return m})}));return d&&!this.isRequiringDone?{ready:!1,reason:a.get("waitedForRequires")}:this.waitForExtReady&&!this.isExtOnReadyDone?{ready:!1,reason:a.get("waitedForExt")}:this.waitForAppReady&&!this.isAppReadyDone?{ready:!1,reason:a.get("waitedForApp")}:{ready:!0}},simulateMouseClick:function(a,b,c,d){var e=
a.el,f=this.getExt(),f=f&&f.getVersion&&f.getVersion("extjs")&&5==f.getVersion("extjs").major;if("fireEvent"!==this.getSimulateEventsWith()&&!f||"checkbox"!==e.type&&"radio"!==e.type||e.disabled||e.readOnly)this.SUPERARG(arguments);else{var g=e.checked;b?this.SUPER(a,function(){e.checked===g&&(e.checked=!g);b.call(c||this)}):(this.SUPERARG(arguments),e.checked===g&&(e.checked=!g))}}},methods:{initialize:function(){this.expectGlobals("Ext","id");this.SUPER()},start:function(a){var b=this,c=this.getExt();
if(c){this.harness.generateLoaderPathHook()(this.global.StartTest,c,this.loaderPath);c.isReady=!0;var d=c.ClassManager&&Boolean(c.ClassManager.get("Ext.app.Application"));d||(this.waitForAppReady=!1);this.waitForAppReady&&d&&c.util.Observable.observe(c.app.Application,{launch:function(){b.isAppReadyDone=!0},single:!0,delay:100})}else this.waitForExtReady=this.waitForAppReady=!1,this.requires=null;this.SUPERARG(arguments)},getExt:function(){return this.global.Ext},Ext:function(){return this.global.Ext},
...
g.push(a)});d=g}1<d.length&&(e=!0,a=f.get("multipleComponentMatch").replace("{component}",a),this.harness.failOnMultipleComponentMatches?this.fail(a):this.warn(a));a=d[0]}return c.detailed?{comp:a,matchingMultiple:e}:a},compToEl:function(a,b){var c=this.Ext();if(!a)return null;b=!1!==b;c.Editor&&(a instanceof c.Editor&&a.field)&&(a=a.field);if(c&&c.form&&c.form.Field&&b){if(a instanceof c.form.Field&&a.inputEl)return(c=a.el.down(".x-form-field"))&&c.dom||a.inputEl.dom||a.inputEl;if(c.form.HtmlEditor&&
a instanceof c.form.HtmlEditor)return a.iframe||a.inputEl}c&&(c.field&&c.field.Field&&a instanceof c.field.Field&&b)&&(a=a.getComponent());return a.getEl?a.getEl():b&&a.input||a.el||a.element},normalizeElement:function(a,b,c,d,e){if(!a)return null;if(a.nodeName)return a;var f=!1;this.getExt();var g=a,k,l=e&&e.stopAtComponentLevel;e=e&&e.hasOwnProperty("ignoreNonVisible")?e.ignoreNonVisible:!0;if("string"===typeof a){f=a.split("->");if(2===f.length&&(k=this.adjustScope(a),a=this.trimString(f[1]),!k||
(a.match(/^\s*>>/)||a.match(/=>/))&&!this.Ext()))return this.resetScope(),null;if(a.match(/=>/))f=this.compositeQuery(a,null,b,e),a=f[0],f=1<f.length;else if(a.match(/^\s*>>/))f=this.normalizeComponent(a,b,{ignoreNonVisible:e,detailed:!0}),a=f.comp,f=f.matchingMultiple;else return d=this.SUPER(a,b,c,d),k&&this.resetScope(),d;if(!b&&!a)throw d=Siesta.Resource("Siesta.Test.ExtJSCore").get("noComponentFound")+": "+g,this.warn(d),k&&this.resetScope(),d;}g=!1;this.isExtJSComponent(a)&&(l?g=!0:a=this.compToEl(a));
a&&a.dom&&(l?g=!0:a=a.dom);a=g?a:this.SUPER(a,b,c);k&&this.resetScope();return d?{el:a,matchingMultiple:f}:a},normalizeActionTarget:function(a,b){return this.normalizeElement(a,b,!1,!1,{stopAtComponentLevel:!0})},knownBugIn:function(a,b,c){var d=this.getExt(),d=d.versions.extjs||d.versions.touch,e=Siesta.Resource("Siesta.Test.ExtJSCore");this.harness.failKnownBugIn||d.isGreaterThan(a)?b.call(this.global,this):this.todo(e.get("knownBugIn")+" "+a+": "+(c||""),b)},requireOk:function(){var a=this,b=this.getExt(),
c=Array.prototype.concat.apply([],arguments),d=Siesta.Resource("Siesta.Test.ExtJSCore"),e;"Function"==this.typeOf(c[c.length-1])&&(e=c.pop());var f=function(){a.endAsync(k);Joose.A.each(c,function(c){var e=b.ClassManager,f=e.get(c);e.overrideMap&&e.overrideMap[c]||f&&("Function"==a.typeOf(f)||"Function"==a.typeOf(f.self))?a.pass(d.get("Class")+": "+c+" "+d.get("wasLoaded")):a.fail(d.get("Class")+": "+c+" "+d.get("wasNotLoaded"))});a.processCallbackFromTest(e)},g=b.isIE?12E4:3E4,k=this.beginAsync(g+
100),l=!1,m=this.originalSetTimeout,n=this.originalClearTimeout,p=m(function(){l=!0;f()},g);b.Loader.setConfig({enabled:!0});b.require(c,function(){n(p);l||f()})},clickComponentQuery:function(a,b,c){2==arguments.length&&"Function"==this.typeOf(arguments[1])&&(c=b,b=this.Ext().ComponentQuery);1==arguments.length&&(b=this.Ext().ComponentQuery);var d=b.query(a);this.chainClick(d,function(){c&&c.call(this,d)})},clickCQ:function(){this.clickComponentQuery.apply(this,arguments)},compositeQuery:function(a,
b,c,d){c=!1!==c;var e=this.Ext(),f=Siesta.Resource("Siesta.Test.ExtJSCore"),g=a.split("=>"),k;b=b||e.ComponentQuery;if(!b)return[];if(2>g.length)throw f.get("invalidCompositeQuery")+": "+a;if(g[0].match(/\.\w+\(/)){k=this.trimString(g[0]).split(" ");for(e=0;e<k.length;e++){var l=this.trimString(k[e]).split(".");b=b.query(l[0])[0];1<l.length&&(l=l[1].substr(0,l[1].length-2),b=b[l]())}b=[b]}else b=b.query(g[0]);if(!b.length){if(c)return[];throw f.get("ComponentQuery")+" "+g[0]+" "+f.get("matchedNoCmp");
}for(e=0;e<b.length;e++)if(k=b[e],k.rendered&&(!d||(k.isVisible?k.isVisible():!k.isHidden()))&&(k=this.compToEl(k,!1),k=Array.prototype.slice.call($(g[1],k.dom)),0<k.length))return k;if(c)return[];throw f.get("CompositeQuery")+" "+a+" "+f.get("matchedNoCmp");},cq:function(a){return this.Ext().ComponentQuery.query(a)},cq1:function(a){return this.Ext().ComponentQuery.query(a)[0]},waitForTarget:function(a,b,c,d,e){var f=this.SUPER;this.waitForAnimations(function(){f.call(this,a,b,c,d,e)},this,d)},messageBoxIsVisible:function(a){return this.notOk(this.Ext().Msg.isHidden(),
a||Siesta.Resource("Siesta.Test.ExtJSCore","messageBoxVisible"))},messageBoxIsHidden:function(a){return this.ok(this.Ext().Msg.isHidden(),a||Siesta.Resource("Siesta.Test.ExtJSCore","messageBoxHidden"))},cqExists:function(a,b){this.ok(this.cq1(a),b)},cqNotExists:function(a,b){this.notOk(this.cq1(a),b)},componentQueryExists:function(){this.cqExists.apply(this,arguments)},setValue:function(a,b,c,d){a=this.normalizeComponent(a);(a.setRawValue||a.setValue).call(a,b);c&&this.processCallbackFromTest(c,null,
d)},waitForAnimations:function(a,b,c){var d=Siesta.Resource("Siesta.Test.ExtJS"),e=this;return this.waitFor({method:function(){return!e.areAnimationsRunning()},callback:a,scope:b,timeout:c,assertionName:"waitForAnimations",description:" "+d.get("animationsToFinalize")})}}});
...
b.setFilterGroups(a.filterGroups);a.filter&&b.setValue(a.filter);return!a.filter},null,{single:!0});this.on("viewready",this.onMyViewReady,this);this.coverageReportButton=this.down("[actionName=show-coverage]")},onHistoryChange:function(a){a&&(a=this.store.getNodeById(a))&&this.selectTestFile(a)},onDimensionOrOrientationChange:function(a,b){var c=this.viewportSizes[this.framesizeSlider.getValue()],d=this.orientationCheckbox.getValue();this.sizeLabel.setText(c.join("x"));this.fireEvent("framesizechange",

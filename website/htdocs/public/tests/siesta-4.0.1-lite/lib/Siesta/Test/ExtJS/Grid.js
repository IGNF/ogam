...
Role('Siesta.Test.ExtJS.Grid', {
    ...
    methods : {
         ...
         * 
         * @param {Ext.view.Table/Ext.view.Table/String} view The view or a ComponentQuery matching a view
        ...
        waitForRowsVisible : function(view, callback, scope, timeout) {
            if (typeof view === 'function') {
                ...
                scope       = callback;
                callback    = view;
                view       = this.cq1('tableview');
            }

            var cmp = this.normalizeComponent(view, true);
            var me = this;

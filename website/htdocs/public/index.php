...
&& file_exists(INHERENT_APPLICATION_PATH . '/../library')) {
    set_include_path(implode(PATH_SEPARATOR, array(
...
if(defined('INHERENT_APPLICATION_PATH')
&& file_exists(INHERENT_APPLICATION_PATH . '/configs/substitute/application.ini')) {
        $applicationIniFilePath = INHERENT_APPLICATION_PATH . '/configs/substitute/application.ini';
}
$configuration = new Zend_Config_Ini($applicationIniFilePath, APPLICATION_ENV, array('allowModifications' => true));
if(defined('INHERENT_APPLICATION_PATH')
&& file_exists(INHERENT_APPLICATION_PATH . '/configs/patch/application.ini')) {

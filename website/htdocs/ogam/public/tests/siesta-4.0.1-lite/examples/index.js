...

    {
        ...
        items   : [
            ...
            },
            {
                ...
                pageUrl : '3.application-tests/portal/',
        ...
        items : [
            ...
            },
            {
                ...
                items : [
                    ...
                    {
                        pageUrl : '4.testing-3rd-party-libraries/jquery/jquery_ui.html',
                        preload     : 'inherit',
                        alsoPreload : [
            ...
            // polymer example throws exception in IE9 - this is not Siesta's fault, so we just hide it in IE9
            $.browser.msie && $.browser.version <= 9 ? null :
            {
                group       : 'Polymer',
                pageUrl : '4.testing-3rd-party-libraries/polymer/finished',
                items       : [
            ...
            // react example throws exception in IE < 10 - this is not Siesta's fault, so we just hide it in such case
            $.browser.msie && $.browser.version <= 10 ? null :
            {
                group       : 'React',
                pageUrl : '4.testing-3rd-party-libraries/react/',
                items       : [

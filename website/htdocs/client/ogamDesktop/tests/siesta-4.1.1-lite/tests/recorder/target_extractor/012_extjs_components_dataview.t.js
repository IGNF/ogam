    ...
    t.it('DataView 2', function (t) {
        ...
        t.chain(
            ...
            function () {
                ...
                t.is(steps[0].getTarget().target, '#view => div.thumb-wrap:nth-child(1) span.foo:contains(foo 71.72)')
                t.is(steps[1].getTarget().target, '#view => div.thumb-wrap:nth-child(2) span.bar:contains(bar 29.01)')
                t.is(steps[2].getTarget().target, '#view => div.thumb-wrap:nth-child(3) span.baz:contains(baz 83.81)')
            }
        )
    })
    ...
    t.it('DataView 3', function (t) {
        ...
        t.chain(
            ...
            function () {
                ...
                t.is(steps[0].getTarget().target, '#view2 => .thumb-wrap:nth-child(2) span.foo:contains(foo 71.72)')
                t.is(steps[1].getTarget().target, '#view2 => .thumb-wrap:nth-child(3) span.bar:contains(bar 29.01)')
                t.is(steps[2].getTarget().target, '#view2 => .thumb-wrap:nth-child(4) span.baz:contains(baz 83.81)')
            }
        )
    })

...
class LayerTreeNode implements \JsonSerializable
{
     ...
     * @var string
     *
     * @ORM\Column(name="parent_node_id", type="string", length=50)
     */
     ...
     * @var string
     *
     * @ORM\Column(name="definition", type="string", length=100)
     */
    private $definition;
     ...
     * @var layer
     *
     * @ORM\ManyToOne(targetEntity="OGAMBundle\Entity\Mapping\Layer")

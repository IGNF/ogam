 ...
 * @ORM\Entity(repositoryClass="OGAMBundle\Repository\Mapping\ResultLocationRepository")
 */
class ResultLocation
{
     ...
     * @var string
     *
     * @ORM\Column(name="pk", type="string", length=100)
     */
    private $pk;
     ...
     * @var string
     *
     * @ORM\Column(name="the_geom", type="text")
     */
    private $theGeom;
     ...
     * @var \Date
     *
     * @ORM\Column(name="_creationdt", type="date", nullable=true)
     */
    private $creationdt;

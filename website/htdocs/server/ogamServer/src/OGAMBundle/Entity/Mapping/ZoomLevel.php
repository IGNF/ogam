...
class ZoomLevel implements \JsonSerializable
{
	 ...
	 * @var decimal
     *
     * @ORM\Column(name="resolution", type="decimal", nullable=false)
     */
    private $resolution;
     ...
     * @var integer
     *
     * @ORM\Column(name="approx_scale_denom", type="integer", nullable=false)
     */
     ...
     * @var string
     *
     * @ORM\Column(name="scale_label", type="string", length=10, nullable=true)
     */
    private $scaleLabel;
     ...
     * @var integer
     *
     * @ORM\Column(name="is_map_zoom_level", type="boolean", nullable=false)
     */

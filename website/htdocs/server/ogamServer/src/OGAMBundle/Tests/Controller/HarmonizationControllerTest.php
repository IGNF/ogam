...
class HarmonizationControllerTest extends AbstractControllerTest
{
    ...
    public function getNotLoggedUrls(){
        return [
            'indexAction' => [['uri' => '/harmonization/']],
            'showHarmonizationPageAction' => [['uri' => '/harmonization/show-harmonization-page']],
            'launchHarmonizationAction' => [['uri' => '/harmonization/launch-harmonization']],
            'removeHarmonizationDataAction' => [['uri' => '/harmonization/remove-harmonization-data']],
            'getStatusAction' => [['uri' => '/harmonization/get-status']]
        ];
    }

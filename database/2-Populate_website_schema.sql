...
insert into application_parameters (name, value, description) values ( 'mapserver_private_url' , 'http://ogam-integration.ign.fr/mapserv-ogam?' , 'The private URL used by mapserverProxy to request a map server.');
insert into application_parameters (name, value, description) values ( 'tilecache_private_url' , 'http://ogam-integration.ign.fr/tilecache-ogam?' , 'The private URL used by tilecacheProxy to request a tile cache.');

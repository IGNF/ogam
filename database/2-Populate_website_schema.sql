...
INSERT INTO application_parameters (name, value, description) values ('UploadDirectory','%SystemRoot%/TEMP/ogam_upload','Temp directory where the CSV files are uploaded on the server');
...
INSERT INTO application_parameters (name, value, description) values ('autoLogin' , 1 , 'DEFAULT LOGIN AND PAGE FOR PUBLIC ACCESS'); -- 1 need to build the client app correctly (resolution of get-map-parameters)
...
INSERT INTO application_parameters (name, value, description) values ('uploadDir' , 'D:\DONNEES\Workspace\OGAM\website\htdocs\server\ogamServer\upload' , 'INTEGRATION SERVICE : directory where the CSV files are stocked on the server');
...
INSERT INTO application_parameters (name, value, description) values ('query_details_layers1' , 'ORTHOIMAGERY.ORTHOPHOTOS,result_location' , 'WEB MAPPING ');
INSERT INTO application_parameters (name, value, description) values ('query_details_layers2' , 'ORTHOIMAGERY.ORTHOPHOTOS,nuts_0,plot_location_detail' , 'WEB MAPPING ');
...
INSERT INTO application_parameters (name, value, description) values ('featureinfo_typename' , 'result_location' , 'Layer that is queried');

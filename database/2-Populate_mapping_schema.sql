...
INSERT INTO layer (layer_name, layer_label, service_layer_name, istransparent, default_opacity, isbaselayer, isuntiled, maxscale, minscale, has_legend, transitioneffect, imageformat, provider_id, has_sld, activate_type, view_service_name, legend_service_name, print_service_name, detail_service_name, feature_service_name, layer_group_id) VALUES ('result_location', 'Results', 'result_location', 1, NULL, 0, 1, NULL, NULL, 1, NULL, 'PNG', NULL, 0, 'REQUEST', 'mapProxy', 'legend_mapProxy', 'mapProxy', 'local_mapserver', NULL, 7);

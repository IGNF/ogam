...
-- Define the layers
-- Locations
INSERT INTO layer (layer_name, layer_label, service_layer_name, istransparent, default_opacity, isbaselayer, isuntiled, isvector, maxscale, minscale, has_legend, provider_id, activate_type, view_service_name, legend_service_name, print_service_name, detail_service_name, feature_service_name) VALUES ('result_locations', 'Résultats', 'result_locations', 1, 100, 0, 1, 1, NULL, NULL, 0, NULL, 'REQUEST', 'Local_MapProxy_WMS_GetMap', 'Local_MapProxy_WMS_GetLegendGraphic', 'Local_Mapserv_WMS_GetMap', 'Local_MapProxy_WMS_GetMap', NULL);
INSERT INTO layer (layer_name, layer_label, service_layer_name, istransparent, default_opacity, isbaselayer, isuntiled, isvector, maxscale, minscale, has_legend, provider_id, activate_type, view_service_name, legend_service_name, print_service_name, detail_service_name, feature_service_name) VALUES ('all_locations', 'Localisations', 'all_locations', 1, 100, 0, 1, 1, NULL, NULL, 1, NULL, 'NONE', 'Local_MapProxy_WMS_GetMap', 'Local_MapProxy_WMS_GetLegendGraphic', 'Local_Mapserv_WMS_GetMap', 'Local_MapProxy_WMS_GetMap', 'Local_MapProxy_WFS_GetFeature');
...
INSERT INTO layer (layer_name, layer_label, service_layer_name, istransparent, default_opacity, isbaselayer, isuntiled, isvector, maxscale, minscale, has_legend, provider_id, activate_type, view_service_name, legend_service_name, print_service_name, detail_service_name, feature_service_name) VALUES ('location_detail', 'Détail', 'plot_location_detail', 1, 100, 0, 0, 1, NULL, NULL, 0, NULL, 'NONE', NULL, NULL, NULL, 'Local_MapProxy_WMS_GetMap', NULL);
-- Boundaries
...
INSERT INTO layer (layer_name, layer_label, service_layer_name, istransparent, default_opacity, isbaselayer, isuntiled, isvector, maxscale, minscale, has_legend, provider_id, activate_type, view_service_name, legend_service_name, print_service_name, detail_service_name, feature_service_name) VALUES ('countries', 'Pays', 'nuts_0', 1, 100, 0, 0, 0, NULL, 500000, 1, NULL, 'NONE', 'Local_MapProxy_WMS_GetMap', 'Local_MapProxy_WMS_GetLegendGraphic', 'Local_Mapserv_WMS_GetMap', 'Local_MapProxy_WMS_GetMap', 'Local_MapProxy_WFS_GetFeature');
INSERT INTO layer (layer_name, layer_label, service_layer_name, istransparent, default_opacity, isbaselayer, isuntiled, isvector, maxscale, minscale, has_legend, provider_id, activate_type, view_service_name, legend_service_name, print_service_name, detail_service_name, feature_service_name) VALUES ('departements', 'Départements', 'departements', 1, 100, 0, 0, 0, 5000000, 1, 1, NULL, 'NONE', 'Local_MapProxy_WMS_GetMap', 'Local_MapProxy_WMS_GetLegendGraphic', 'Local_Mapserv_WMS_GetMap', 'Local_MapProxy_WMS_GetMap', 'Local_MapProxy_WFS_GetFeature');
INSERT INTO layer (layer_name, layer_label, service_layer_name, istransparent, default_opacity, isbaselayer, isuntiled, isvector, maxscale, minscale, has_legend, provider_id, activate_type, view_service_name, legend_service_name, print_service_name, detail_service_name, feature_service_name) VALUES ('communes', 'Communes', 'communes', 1, 100, 0, 0, 0, 500000, 1, 1, NULL, 'NONE', 'Local_MapProxy_WMS_GetMap', 'Local_MapProxy_WMS_GetLegendGraphic', 'Local_Mapserv_WMS_GetMap', 'Local_MapProxy_WMS_GetMap', 'Local_MapProxy_WFS_GetFeature');
-- Background

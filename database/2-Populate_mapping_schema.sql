...
INSERT INTO layer_service (service_name, config) VALUES ('mapProxy_wfs', '{"urls":["http://www.ogam.fr/mapProxy.php?"],"params":{"SERVICE":"WFS","VERSION":"1.1.0","REQUEST":"GetFeature"}}');
...
INSERT INTO layer (layer_name, layer_label, service_layer_name, istransparent, default_opacity, isbaselayer, isuntiled, maxscale, minscale, has_legend, transitioneffect, imageformat, provider_id, has_sld, activate_type, view_service_name, legend_service_name, print_service_name, detail_service_name, feature_service_name, layer_group_id) VALUES ('nuts_0', 'Country Boundaries', 'nuts_0', 1, NULL, 0, 0, NULL, 500000, 1, 'resize', 'PNG', NULL, 0, 'NONE', 'mapProxy', 'legend_mapProxy', 'local_mapserver', 'mapProxy', 'mapProxy_wfs', 5);
...
INSERT INTO layer (layer_name, layer_label, service_layer_name, istransparent, default_opacity, isbaselayer, isuntiled, maxscale, minscale, has_legend, transitioneffect, imageformat, provider_id, has_sld, activate_type, view_service_name, legend_service_name, print_service_name, detail_service_name, feature_service_name, layer_group_id) VALUES ('all_locations', 'Plot Locations', 'all_locations', 1, NULL, 0, 1, NULL, NULL, 1, NULL, 'PNG', NULL, 0, 'NONE', 'mapProxy', 'legend_mapProxy', 'local_mapserver', 'local_mapserver', 'mapProxy_wfs', 2);

...
\COPY unit from 'unit.csv' with delimiter ';' null '';
\COPY data from 'data.csv' with delimiter ';' null '';
\COPY range from 'range.csv' with delimiter ';' null '';
\COPY mode from 'mode.csv' with delimiter ';' null '';
\COPY group_mode from 'group_mode.csv' with delimiter ';' null '';
\COPY mode_tree from 'mode_tree.csv' with delimiter ';' null '';
\COPY dynamode from 'dynamode.csv' with delimiter ';' null '';

\COPY form_format from 'form_format.csv' with delimiter ';' null '';
\COPY table_format from 'table_format.csv' with delimiter ';' null '';
\COPY file_format from 'file_format.csv' with delimiter ';' null '';
...
\COPY form_field from 'form_field.csv' with delimiter ';' null '';
\COPY file_field from 'file_field.csv' with delimiter ';' null '';
\COPY table_field from 'table_field.csv' with delimiter ';' null '';
...
\COPY field_mapping from 'field_mapping.csv' with delimiter ';' null '';

\COPY checks (check_id, step, name, label, description, "statement", importance) from 'checks.csv' with delimiter ';' null '';


\COPY dataset from 'dataset.csv' with delimiter ';' null '';
\COPY dataset_fields from 'dataset_fields.csv' with delimiter ';' null '';
\COPY dataset_files from 'dataset_files.csv' with delimiter ';' null '';

\COPY table_schema from 'table_schema.csv' with delimiter ';' null '';
\COPY table_tree from 'table_tree.csv' with delimiter ';' null '';

\COPY translation from 'translation.csv' with delimiter ';' null '';

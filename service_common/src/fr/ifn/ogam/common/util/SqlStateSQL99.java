 ...
 * http://doxygen.postgresql.org/errcodes_8h-source.html
 * 
 * @author sgalopin
 * 
 * 
 * Generated on Wed Jun 6 03:06:08 2007 for PostgreSQL Source Code by doxygen
 * 1.4.7
 * 
 */
public interface SqlStateSQL99 {
    ...
    /*
         ...
         * syntactical and semantic errors. We have borrowed codes from IBM's
         * DB2 and invented our own codes to develop a useful code set.
         * 
         * When adding a new code, make sure it is placed in the most
         * appropriate class (the first two characters of the code value
         * identify the class). The listing is organized by class to make this
         * prominent.
         * 
         * The generic '000' subclass code should be used for an error only when
         * there is not a more-specific subclass code defined.
         * 
         * The SQL spec requires that all the elements of a SQLSTATE code be
         * either digits or upper-case ASCII characters.
         * 
         * Classes that begin with 0-4 or A-H are defined by the standard.
         * Within such a class, subclass values defined by the standard must
         * begin with 0-4 or A-H. To define a new error code, ensure that it is
         * either in an "implementation-defined class" (it begins with 5-9 or
         * I-Z), or its subclass falls outside the range of error codes that
         * could be present in future versions of the standard (i.e. the
         * subclass value begins with 5-9 or I-Z).
         * 
         * The convention is that new error codes defined by PostgreSQL in a
         * class defined by the standard have a subclass value that begins with
         * 'P'. In addition, error codes defined by PostgreSQL clients (such as
         * ecpg) have a class value that begins with 'Y'.
         */
    ...
    /*
         ...
         * "objects"). (The first four categories are mandated by the existence
         * of separate SQLSTATE classes for them in the spec; in this file,
         * however, we group the ERRCODE names with all the rest under class
         * 42.) Parameters are sort-of-named objects and get their own ERRCODE.
         * 
         * The same breakdown is used for "duplicate" and "ambiguous"
         * complaints, as well as complaints associated with incorrect
         * declarations.
         */

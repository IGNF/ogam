...
COPY unit from 'D:/workspace/OGAM/Bases SQL/Metadata/unit.csv' with delimiter ';' null '';
COPY data from 'D:/workspace/OGAM/Bases SQL/Metadata/data.csv' with delimiter ';' null '';
COPY range from 'D:/workspace/OGAM/Bases SQL/Metadata/range.csv' with delimiter ';' null '';
COPY mode from 'D:/workspace/OGAM/Bases SQL/Metadata/mode.csv' with delimiter ';' null '';
COPY group_mode from 'D:/workspace/OGAM/Bases SQL/Metadata/group_mode.csv' with delimiter ';' null '';
COPY mode_tree from 'D:/workspace/OGAM/Bases SQL/Metadata/mode_tree.csv' with delimiter ';' null '';
COPY dynamode from 'D:/workspace/OGAM/Bases SQL/Metadata/dynamode.csv' with delimiter ';' null '';

COPY form_format from 'D:/workspace/OGAM/Bases SQL/Metadata/form_format.csv' with delimiter ';' null '';
COPY table_format from 'D:/workspace/OGAM/Bases SQL/Metadata/table_format.csv' with delimiter ';' null '';
COPY file_format from 'D:/workspace/OGAM/Bases SQL/Metadata/file_format.csv' with delimiter ';' null '';
...
COPY form_field from 'D:/workspace/OGAM/Bases SQL/Metadata/form_field.csv' with delimiter ';' null '';
COPY file_field from 'D:/workspace/OGAM/Bases SQL/Metadata/file_field.csv' with delimiter ';' null '';
COPY table_field from 'D:/workspace/OGAM/Bases SQL/Metadata/table_field.csv' with delimiter ';' null '';
...
COPY field_mapping from 'D:/workspace/OGAM/Bases SQL/Metadata/field_mapping.csv' with delimiter ';' null '';

COPY checks (check_id, step, name, label, description, "statement", importance) from 'D:/workspace/OGAM/Bases SQL/Metadata/checks.csv' with delimiter ';' null '';


COPY dataset from 'D:/workspace/OGAM/Bases SQL/Metadata/dataset.csv' with delimiter ';' null '';
COPY dataset_fields from 'D:/workspace/OGAM/Bases SQL/Metadata/dataset_fields.csv' with delimiter ';' null '';
COPY dataset_files from 'D:/workspace/OGAM/Bases SQL/Metadata/dataset_files.csv' with delimiter ';' null '';

COPY table_schema from 'D:/workspace/OGAM/Bases SQL/Metadata/table_schema.csv' with delimiter ';' null '';
COPY table_tree from 'D:/workspace/OGAM/Bases SQL/Metadata/table_tree.csv' with delimiter ';' null '';

COPY translation from 'D:/workspace/OGAM/Bases SQL/Metadata/translation.csv' with delimiter ';' null '';

...
COMMENT ON COLUMN PK_PREDEFINED_REQUEST_RESULT.REQUEST_NAME IS 'The request name';
COMMENT ON COLUMN PK_PREDEFINED_REQUEST_RESULT.FORMAT IS 'The form format of the result column';
COMMENT ON COLUMN PK_PREDEFINED_REQUEST_RESULT.DATA IS 'The form field of the result column';
